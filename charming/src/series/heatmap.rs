...
pub struct Heatmap {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    blur_size: Option<i64>,

    #[serde(skip_serializing_if = "Option::is_none")]
    min_opacity: Option<i64>,

    #[serde(skip_serializing_if = "Option::is_none")]
    max_opacity: Option<i64>,
...
impl Heatmap {
    ...
    pub fn point_size<F: Into<i64>>(mut self, point_size: F) -> Self {
        self.point_size = Some(point_size.into());
        self
    }

    pub fn blur_size<F: Into<i64>>(mut self, blur_size: F) -> Self {
        self.blur_size = Some(blur_size.into());
        self
    }

    pub fn min_opacity<F: Into<i64>>(mut self, min_opacity: F) -> Self {
        self.min_opacity = Some(min_opacity.into());
        self
    }

    pub fn max_opacity<F: Into<i64>>(mut self, max_opacity: F) -> Self {
